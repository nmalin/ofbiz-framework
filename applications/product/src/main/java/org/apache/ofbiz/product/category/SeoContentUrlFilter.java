...
public class SeoContentUrlFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (UtilValidate.isNotEmpty(pathInfo) && pathInfo.endsWith("-content")) {
            String alternativeUrl = URLDecoder.decode(pathInfo.substring(pathInfo.lastIndexOf('/') + 1), "UTF-8");
            ...
            if (urlContent != null) {
                ...
                String controlServlet = SeoControlServlet.getControlServlet();
                urlBuilder.append("/");
                if (UtilValidate.isNotEmpty(controlServlet)) {
                    ...
                    urlBuilder.append(config.getInitParameter("viewRequest"))
                            .append("?contentId=")
                            .append(urlContent.getString("contentIdStart"));
                }
